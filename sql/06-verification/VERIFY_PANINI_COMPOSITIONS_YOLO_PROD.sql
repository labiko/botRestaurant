-- ========================================================================
-- VÉRIFICATION - COMPOSITIONS PANINI PIZZA YOLO
-- DATE: 2025-01-16
-- RESTAURANT: Pizza Yolo 77 (ID: 1)
-- CATÉGORIE: PANINI (ID: 17)
--
-- OBJECTIF: Vérifier si les produits PANINI ont des compositions
-- IDs à vérifier: 187, 188, 189, 190, 191
-- ========================================================================

-- Afficher les produits PANINI avec leurs compositions
SELECT
    p.id,
...
AND p.id IN (187, 188, 189, 190, 191)
ORDER BY p.id;
