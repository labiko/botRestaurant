...
--
-- Name: delete_category_complete(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.delete_category_complete(p_category_id integer, p_restaurant_id integer) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION public.delete_category_complete(p_category_id integer, p_restaurant_id integer) OWNER TO postgres;

--
-- Name: delete_restaurant_complete(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.delete_restaurant_complete(p_restaurant_id integer) RETURNS json
    LANGUAGE plpgsql
    AS $$
  DECLARE
...
ALTER FUNCTION public.delete_restaurant_complete(p_restaurant_id integer) OWNER TO postgres;
...
--
-- Name: generate_unique_vitrine_slug(text, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.generate_unique_vitrine_slug(restaurant_name text, restaurant_id integer) RETURNS text
    LANGUAGE plpgsql
    AS $$
DECLARE
    base_slug TEXT;
...
ALTER FUNCTION public.generate_unique_vitrine_slug(restaurant_name text, restaurant_id integer) OWNER TO postgres;
...
--
-- Name: preview_restaurant_deletion(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.preview_restaurant_deletion(p_restaurant_id integer) RETURNS json
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_restaurant_name TEXT;
...
ALTER FUNCTION public.preview_restaurant_deletion(p_restaurant_id integer) OWNER TO postgres;
...
--
-- Name: update_vitrine_updated_at(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_vitrine_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION public.update_vitrine_updated_at() OWNER TO postgres;
...
--
-- Name: duplication_actions; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.duplication_actions OWNER TO postgres;

--
-- Name: TABLE duplication_actions; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.duplication_actions IS 'Détail de chaque action effectuée pendant la duplication';


--
-- Name: COLUMN duplication_actions.action_type; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.duplication_actions.action_type IS 'Type daction: create_restaurant, duplicate_category, duplicate_product, duplicate_option';


--
-- Name: COLUMN duplication_actions.entity_type; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.duplication_actions.entity_type IS 'Type dentité: restaurant, category, product, option';


--
-- Name: duplication_actions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.duplication_actions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.duplication_actions_id_seq OWNER TO postgres;

--
-- Name: duplication_actions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.duplication_actions_id_seq OWNED BY public.duplication_actions.id;


--
-- Name: duplication_logs; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.duplication_logs (
    ...
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
    production_status character varying(20) DEFAULT 'dev_only'::character varying,
    last_production_sync timestamp without time zone,
    sync_count integer DEFAULT 0,
    CONSTRAINT duplication_logs_status_check CHECK (((status)::text = ANY ((ARRAY['started'::character varying, 'in_progress'::character varying, 'completed'::character varying, 'failed'::character varying])::text[])))
);


ALTER TABLE public.duplication_logs OWNER TO postgres;

--
-- Name: TABLE duplication_logs; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.duplication_logs IS 'Log principal de chaque duplication de restaurant';


--
-- Name: COLUMN duplication_logs.status; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.duplication_logs.status IS 'Statut: started, in_progress, completed, failed';


--
-- Name: COLUMN duplication_logs.summary; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.duplication_logs.summary IS 'Résumé final avec statistiques (JSON)';


--
-- Name: COLUMN duplication_logs.details; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.duplication_logs.details IS 'Détails de configuration et paramètres (JSON)';


--
-- Name: duplication_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.duplication_logs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.duplication_logs_id_seq OWNER TO postgres;

--
-- Name: duplication_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.duplication_logs_id_seq OWNED BY public.duplication_logs.id;
...
CREATE TABLE public.france_delivery_assignments (
    ...
    CONSTRAINT france_delivery_assignments_assignment_status_check CHECK (((assignment_status)::text = ANY (ARRAY[('pending'::character varying)::text, ('accepted'::character varying)::text, ('rejected'::character varying)::text, ('expired'::character varying)::text]))),
...
CREATE TABLE public.france_orders (
    ...
    CONSTRAINT france_orders_driver_assignment_status_check CHECK (((driver_assignment_status)::text = ANY (ARRAY[('none'::character varying)::text, ('searching'::character varying)::text, ('assigned'::character varying)::text, ('delivered'::character varying)::text]))),
    CONSTRAINT france_orders_status_check CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('confirmee'::character varying)::text, ('preparation'::character varying)::text, ('prete'::character varying)::text, ('assignee'::character varying)::text, ('en_livraison'::character varying)::text, ('livree'::character varying)::text, ('servie'::character varying)::text, ('recuperee'::character varying)::text, ('annulee'::character varying)::text])))
);
...
CREATE VIEW public.france_active_assignments AS
 SELECT a.id,
  ...
  WHERE ((a.assignment_status)::text = ANY (ARRAY[('pending'::character varying)::text, ('accepted'::character varying)::text]));
...
CREATE TABLE public.france_auth_sessions (
    ...
    ip_address inet,
    user_agent text,
    CONSTRAINT france_auth_sessions_user_type_check CHECK (((user_type)::text = ANY (ARRAY[('restaurant'::character varying)::text, ('driver'::character varying)::text])))
);
...
CREATE TABLE public.france_delivery_notifications (
    ...
    error_message text,
    CONSTRAINT france_delivery_notifications_delivery_status_check CHECK (((delivery_status)::text = ANY (ARRAY[('pending'::character varying)::text, ('sent'::character varying)::text, ('delivered'::character varying)::text, ('failed'::character varying)::text]))),
    CONSTRAINT france_delivery_notifications_notification_type_check CHECK (((notification_type)::text = ANY (ARRAY[('assignment_offer'::character varying)::text, ('assignment_accepted'::character varying)::text, ('assignment_rejected'::character varying)::text, ('delivery_started'::character varying)::text, ('delivery_completed'::character varying)::text]))),
    CONSTRAINT france_delivery_notifications_recipient_type_check CHECK (((recipient_type)::text = ANY (ARRAY[('driver'::character varying)::text, ('restaurant'::character varying)::text, ('customer'::character varying)::text])))
);
...
--
-- Name: france_option_groups; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.france_option_groups (
    ...
    unit character varying(50) DEFAULT 'choix'::character varying,
...
ALTER TABLE public.france_option_groups OWNER TO postgres;

--
-- Name: france_option_groups_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.france_option_groups_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.france_option_groups_id_seq OWNER TO postgres;

--
-- Name: france_option_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.france_option_groups_id_seq OWNED BY public.france_option_groups.id;
...
CREATE TABLE public.france_restaurant_service_modes (
    ...
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
    CONSTRAINT france_restaurant_service_modes_service_mode_check CHECK (((service_mode)::text = ANY (ARRAY[('sur_place'::character varying)::text, ('a_emporter'::character varying)::text, ('livraison'::character varying)::text])))
);
...
--
-- Name: TABLE login_users; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.login_users IS 'Table d''authentification pour les utilisateurs admin MenuAI';


--
-- Name: COLUMN login_users.email; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.login_users.email IS 'Email unique de l''utilisateur';


--
-- Name: COLUMN login_users.password_hash; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.login_users.password_hash IS 'Hash du mot de passe (bcrypt)';


--
-- Name: COLUMN login_users.last_login; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.login_users.last_login IS 'Timestamp de la dernière connexion';


--
-- Name: COLUMN login_users.created_at; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.login_users.created_at IS 'Date de création du compte';


--
-- Name: COLUMN login_users.updated_at; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.login_users.updated_at IS 'Date de dernière modification';


--
-- Name: login_users_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.login_users_id_seq OWNER TO postgres;

--
-- Name: login_users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: production_sync_history; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.production_sync_history OWNER TO postgres;

--
-- Name: TABLE production_sync_history; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.production_sync_history IS 'Historique des synchronisations DEV vers PRODUCTION';


--
-- Name: COLUMN production_sync_history.sync_type; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.production_sync_history.sync_type IS 'Type: initial, update, category';


--
-- Name: COLUMN production_sync_history.items_synced; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.production_sync_history.items_synced IS 'Détail JSON des éléments synchronisés';


--
-- Name: COLUMN production_sync_history.execution_status; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.production_sync_history.execution_status IS 'Statut: pending, executed, failed';


--
-- Name: production_sync_history_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.production_sync_history_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.production_sync_history_id_seq OWNER TO postgres;

--
-- Name: production_sync_history_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.production_sync_history_id_seq OWNED BY public.production_sync_history.id;
...
--
-- Name: TABLE restaurant_vitrine_settings; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.restaurant_vitrine_settings IS 'Paramètres de personnalisation des pages vitrine pour chaque restaurant';


--
-- Name: COLUMN restaurant_vitrine_settings.restaurant_id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.restaurant_vitrine_settings.restaurant_id IS 'Référence vers le restaurant (france_restaurants.id)';


--
-- Name: COLUMN restaurant_vitrine_settings.slug; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.restaurant_vitrine_settings.slug IS 'URL slug unique pour la page vitrine (/vitrine/slug)';


--
-- Name: COLUMN restaurant_vitrine_settings.primary_color; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.restaurant_vitrine_settings.primary_color IS 'Couleur principale (hex) utilisée pour les éléments principaux';


--
-- Name: COLUMN restaurant_vitrine_settings.secondary_color; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.restaurant_vitrine_settings.secondary_color IS 'Couleur secondaire (hex) pour les dégradés et éléments secondaires';


--
-- Name: COLUMN restaurant_vitrine_settings.feature_1; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.restaurant_vitrine_settings.feature_1 IS 'Premier point fort au format JSON: {"emoji": "🚀", "text": "Description"}';


--
-- Name: COLUMN restaurant_vitrine_settings.feature_2; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.restaurant_vitrine_settings.feature_2 IS 'Deuxième point fort au format JSON: {"emoji": "💯", "text": "Description"}';


--
-- Name: COLUMN restaurant_vitrine_settings.feature_3; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.restaurant_vitrine_settings.feature_3 IS 'Troisième point fort au format JSON: {"emoji": "⭐", "text": "Description"}';
...
--
-- Name: sql_execution_log; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.sql_execution_log OWNER TO postgres;

--
-- Name: sql_execution_log_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.sql_execution_log_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.sql_execution_log_id_seq OWNER TO postgres;

--
-- Name: sql_execution_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.sql_execution_log_id_seq OWNED BY public.sql_execution_log.id;
...
--
-- Name: workflow_sql_scripts; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.workflow_sql_scripts OWNER TO postgres;

--
-- Name: workflow_sql_scripts_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.workflow_sql_scripts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.workflow_sql_scripts_id_seq OWNER TO postgres;

--
-- Name: workflow_sql_scripts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.workflow_sql_scripts_id_seq OWNED BY public.workflow_sql_scripts.id;
...
--
-- Name: duplication_actions id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.duplication_actions ALTER COLUMN id SET DEFAULT nextval('public.duplication_actions_id_seq'::regclass);


--
-- Name: duplication_logs id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.duplication_logs ALTER COLUMN id SET DEFAULT nextval('public.duplication_logs_id_seq'::regclass);
...
--
-- Name: france_option_groups id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.france_option_groups ALTER COLUMN id SET DEFAULT nextval('public.france_option_groups_id_seq'::regclass);
...
--
-- Name: login_users id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: production_sync_history id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.production_sync_history ALTER COLUMN id SET DEFAULT nextval('public.production_sync_history_id_seq'::regclass);
...
--
-- Name: sql_execution_log id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sql_execution_log ALTER COLUMN id SET DEFAULT nextval('public.sql_execution_log_id_seq'::regclass);
...
--
-- Name: workflow_sql_scripts id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.workflow_sql_scripts ALTER COLUMN id SET DEFAULT nextval('public.workflow_sql_scripts_id_seq'::regclass);
...
--
-- Name: duplication_actions duplication_actions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.duplication_actions
    ADD CONSTRAINT duplication_actions_pkey PRIMARY KEY (id);


--
-- Name: duplication_logs duplication_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.duplication_logs
    ADD CONSTRAINT duplication_logs_pkey PRIMARY KEY (id);
...
--
-- Name: france_option_groups france_option_groups_group_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.france_option_groups
    ADD CONSTRAINT france_option_groups_group_name_key UNIQUE (group_name);


--
-- Name: france_option_groups france_option_groups_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.france_option_groups
    ADD CONSTRAINT france_option_groups_pkey PRIMARY KEY (id);
...
--
-- Name: login_users login_users_email_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: production_sync_history production_sync_history_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.production_sync_history
    ADD CONSTRAINT production_sync_history_pkey PRIMARY KEY (id);
...
--
-- Name: sql_execution_log sql_execution_log_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sql_execution_log
    ADD CONSTRAINT sql_execution_log_pkey PRIMARY KEY (id);
...
--
-- Name: workflow_sql_scripts workflow_sql_scripts_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.workflow_sql_scripts
    ADD CONSTRAINT workflow_sql_scripts_pkey PRIMARY KEY (id);
...
--
-- Name: idx_duplication_actions_log_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_duplication_actions_log_id ON public.duplication_actions USING btree (duplication_log_id);


--
-- Name: idx_duplication_actions_type; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_duplication_actions_type ON public.duplication_actions USING btree (action_type);


--
-- Name: idx_duplication_logs_created_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_duplication_logs_created_at ON public.duplication_logs USING btree (created_at);


--
-- Name: idx_duplication_logs_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_duplication_logs_status ON public.duplication_logs USING btree (status);
...
--
-- Name: idx_france_option_groups_active; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_france_option_groups_active ON public.france_option_groups USING btree (is_active, display_order);


--
-- Name: idx_france_option_groups_name; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_france_option_groups_name ON public.france_option_groups USING btree (group_name);
...
--
-- Name: idx_login_users_email; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_login_users_email ON public.login_users USING btree (email);
...
--
-- Name: idx_production_sync_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_production_sync_date ON public.production_sync_history USING btree (sync_date DESC);


--
-- Name: idx_production_sync_duplication_log; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_production_sync_duplication_log ON public.production_sync_history USING btree (duplication_log_id);


--
-- Name: idx_production_sync_restaurant; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_production_sync_restaurant ON public.production_sync_history USING btree (restaurant_id);
...
--
-- Name: idx_workflow_scripts_created_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_workflow_scripts_created_at ON public.workflow_sql_scripts USING btree (created_at DESC);


--
-- Name: idx_workflow_scripts_product_created; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_workflow_scripts_product_created ON public.workflow_sql_scripts USING btree (product_id, created_at DESC);


--
-- Name: idx_workflow_scripts_product_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_workflow_scripts_product_id ON public.workflow_sql_scripts USING btree (product_id);
...
--
-- Name: restaurant_vitrine_settings trigger_update_vitrine_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_update_vitrine_updated_at BEFORE UPDATE ON public.restaurant_vitrine_settings FOR EACH ROW EXECUTE FUNCTION public.update_vitrine_updated_at();
...
--
-- Name: duplication_logs update_duplication_logs_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_duplication_logs_updated_at BEFORE UPDATE ON public.duplication_logs FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: login_users update_login_users_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_login_users_updated_at BEFORE UPDATE ON public.login_users FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: duplication_actions duplication_actions_duplication_log_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.duplication_actions
    ADD CONSTRAINT duplication_actions_duplication_log_id_fkey FOREIGN KEY (duplication_log_id) REFERENCES public.duplication_logs(id) ON DELETE CASCADE;


--
-- Name: duplication_logs duplication_logs_source_restaurant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.duplication_logs
    ADD CONSTRAINT duplication_logs_source_restaurant_id_fkey FOREIGN KEY (source_restaurant_id) REFERENCES public.france_restaurants(id);


--
-- Name: duplication_logs duplication_logs_target_restaurant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.duplication_logs
    ADD CONSTRAINT duplication_logs_target_restaurant_id_fkey FOREIGN KEY (target_restaurant_id) REFERENCES public.france_restaurants(id);


--
-- Name: workflow_sql_scripts fk_workflow_scripts_product; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.workflow_sql_scripts
    ADD CONSTRAINT fk_workflow_scripts_product FOREIGN KEY (product_id) REFERENCES public.france_products(id) ON DELETE CASCADE;
...
--
-- Name: production_sync_history production_sync_history_duplication_log_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.production_sync_history
    ADD CONSTRAINT production_sync_history_duplication_log_id_fkey FOREIGN KEY (duplication_log_id) REFERENCES public.duplication_logs(id);
...
--
-- Name: sql_execution_log sql_execution_log_executed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sql_execution_log
    ADD CONSTRAINT sql_execution_log_executed_by_fkey FOREIGN KEY (executed_by) REFERENCES auth.users(id);
...
--
-- Name: sql_execution_log Permettre gestion log SQL; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Permettre gestion log SQL" ON public.sql_execution_log TO authenticated USING (true) WITH CHECK (true);


--
-- Name: sql_execution_log; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION delete_category_complete(p_category_id integer, p_restaurant_id integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.delete_category_complete(p_category_id integer, p_restaurant_id integer) TO anon;
GRANT ALL ON FUNCTION public.delete_category_complete(p_category_id integer, p_restaurant_id integer) TO authenticated;
GRANT ALL ON FUNCTION public.delete_category_complete(p_category_id integer, p_restaurant_id integer) TO service_role;


--
-- Name: FUNCTION delete_restaurant_complete(p_restaurant_id integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.delete_restaurant_complete(p_restaurant_id integer) TO anon;
GRANT ALL ON FUNCTION public.delete_restaurant_complete(p_restaurant_id integer) TO authenticated;
GRANT ALL ON FUNCTION public.delete_restaurant_complete(p_restaurant_id integer) TO service_role;
...
--
-- Name: FUNCTION generate_unique_vitrine_slug(restaurant_name text, restaurant_id integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.generate_unique_vitrine_slug(restaurant_name text, restaurant_id integer) TO anon;
GRANT ALL ON FUNCTION public.generate_unique_vitrine_slug(restaurant_name text, restaurant_id integer) TO authenticated;
GRANT ALL ON FUNCTION public.generate_unique_vitrine_slug(restaurant_name text, restaurant_id integer) TO service_role;
...
--
-- Name: FUNCTION preview_restaurant_deletion(p_restaurant_id integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.preview_restaurant_deletion(p_restaurant_id integer) TO anon;
GRANT ALL ON FUNCTION public.preview_restaurant_deletion(p_restaurant_id integer) TO authenticated;
GRANT ALL ON FUNCTION public.preview_restaurant_deletion(p_restaurant_id integer) TO service_role;
...
--
-- Name: FUNCTION update_vitrine_updated_at(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.update_vitrine_updated_at() TO anon;
GRANT ALL ON FUNCTION public.update_vitrine_updated_at() TO authenticated;
GRANT ALL ON FUNCTION public.update_vitrine_updated_at() TO service_role;
...
--
-- Name: TABLE duplication_actions; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.duplication_actions TO anon;
GRANT ALL ON TABLE public.duplication_actions TO authenticated;
GRANT ALL ON TABLE public.duplication_actions TO service_role;


--
-- Name: SEQUENCE duplication_actions_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.duplication_actions_id_seq TO anon;
GRANT ALL ON SEQUENCE public.duplication_actions_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.duplication_actions_id_seq TO service_role;


--
-- Name: TABLE duplication_logs; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.duplication_logs TO anon;
GRANT ALL ON TABLE public.duplication_logs TO authenticated;
GRANT ALL ON TABLE public.duplication_logs TO service_role;


--
-- Name: SEQUENCE duplication_logs_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.duplication_logs_id_seq TO anon;
GRANT ALL ON SEQUENCE public.duplication_logs_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.duplication_logs_id_seq TO service_role;
...
--
-- Name: TABLE france_option_groups; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.france_option_groups TO anon;
GRANT ALL ON TABLE public.france_option_groups TO authenticated;
GRANT ALL ON TABLE public.france_option_groups TO service_role;


--
-- Name: SEQUENCE france_option_groups_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.france_option_groups_id_seq TO anon;
GRANT ALL ON SEQUENCE public.france_option_groups_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.france_option_groups_id_seq TO service_role;
...
--
-- Name: TABLE login_users; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.login_users TO anon;
GRANT ALL ON TABLE public.login_users TO authenticated;
GRANT ALL ON TABLE public.login_users TO service_role;


--
-- Name: SEQUENCE login_users_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.login_users_id_seq TO anon;
GRANT ALL ON SEQUENCE public.login_users_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.login_users_id_seq TO service_role;
...
--
-- Name: TABLE production_sync_history; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.production_sync_history TO anon;
GRANT ALL ON TABLE public.production_sync_history TO authenticated;
GRANT ALL ON TABLE public.production_sync_history TO service_role;


--
-- Name: SEQUENCE production_sync_history_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.production_sync_history_id_seq TO anon;
GRANT ALL ON SEQUENCE public.production_sync_history_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.production_sync_history_id_seq TO service_role;
...
--
-- Name: TABLE sql_execution_log; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.sql_execution_log TO anon;
GRANT ALL ON TABLE public.sql_execution_log TO authenticated;
GRANT ALL ON TABLE public.sql_execution_log TO service_role;


--
-- Name: SEQUENCE sql_execution_log_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.sql_execution_log_id_seq TO anon;
GRANT ALL ON SEQUENCE public.sql_execution_log_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.sql_execution_log_id_seq TO service_role;
...
--
-- Name: TABLE workflow_sql_scripts; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.workflow_sql_scripts TO anon;
GRANT ALL ON TABLE public.workflow_sql_scripts TO authenticated;
GRANT ALL ON TABLE public.workflow_sql_scripts TO service_role;


--
-- Name: SEQUENCE workflow_sql_scripts_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.workflow_sql_scripts_id_seq TO anon;
GRANT ALL ON SEQUENCE public.workflow_sql_scripts_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.workflow_sql_scripts_id_seq TO service_role;
